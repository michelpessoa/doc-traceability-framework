...
YAML: 91557 bytes; mapa + maior seção: 12606 (13.8% de 15%)
Total: 22 seções
...
| §5 | INCIDENTES E POSTMORTEM (FLUXO APARTADO) | `incident_lifecycle` +3 | 576-641 | 3594 | Incidente e postmortem têm ciclo próprio (open a closed), fora do padrão |
...
| §14 | GATE OBRIGATÓRIO: NENHUM COMMIT DE IMPLEMENTAÇÃO DIRETO EM MAIN | `gate_branch_before_commit` | 1084-1141 | 3705 | Gate: sem commit de implementação direto em main |
| §15 | GATE OBRIGATÓRIO: QUALIDADE DE CONTEÚDO DA SPEC E DA SDD | `gate_content_quality` | 1143-1235 | 6196 | Gate de conteúdo: SPEC e SDD sem placeholder antes de in_review |

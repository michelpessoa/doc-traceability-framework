...
_Gerado automaticamente a partir de `registry.yaml` em 2026-09-15 21:56. Não editar manualmente. Framework v2.1.0._
...
| `SDD-DTF-0031` | check_ears confunde coluna Arquivos com critério em SPEC de 4 colunas | approved | Michel Pessoa | 2026-09-15 | SDD-DTF-0030 |

...
_Gerado automaticamente a partir de `registry.yaml` em 2026-09-03 22:34. Não editar manualmente. Framework v2.1.0._
...
| `SDD-DTF-0002` | Modo greenfield: registry sem repositório de código e textos de entrada | approved | Michel Pessoa | 2026-08-29 | SPEC-DTF-0002, SDD-DTF-0001 |
| `SDD-DTF-0003` | Datação das exigências do gate 16 em validate_state.py | approved | Michel Pessoa | 2026-08-29 | SPEC-DTF-0003 |
| `SDD-DTF-0004` | Exclusão de artefatos operacionais na varredura de documentos | approved | Michel Pessoa | 2026-08-29 | SPEC-DTF-0005 |
| `SDD-DTF-0005` | Porta de entrada única e documentação gerada | approved | Michel Pessoa | 2026-08-29 | SPEC-DTF-0004, ADR-DTF-0001 |
...
| `SDD-DTF-0010` | Fecha lacuna do harness score: skills expostas + teste real prometido em SDD-DTF-0009 | approved | Michel Pessoa | 2026-09-04 | SDD-DTF-0009 |
